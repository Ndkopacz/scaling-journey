...
public class SpriteSpellcast {
    ...
    public static BufferedImage loadSprite(String file) {
        ...
        try {
            sprite = ImageIO.read(new File("assets/spritesheets/spellcast/" + file));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        	spriteSheet_shield = loadSprite("WEAPON_longsword.png");
//        }
...
//        sprites[7] = spriteSheet_shield.getSubimage(xGrid * TILE_SIZE_LARGE, yGrid * TILE_SIZE_LARGE, TILE_SIZE_LARGE, TILE_SIZE_LARGE);
